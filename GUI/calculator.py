...
e.grid( row = 0, column = 0, columnspan = 30, pady =10)
...
def button_equal():
	second_number = e.get()
	e.delete(0, END)
	if f_condition == "addition":
		e.insert(0, f_num + int(second_number))
	elif f_condition == "multiply":
		e.insert(0, f_num * int(second_number))
	elif f_condition == "subtract":
		e.insert(0, f_num - int(second_number))
	elif f_condition == "addition":
		e.insert(0, f_num / int(second_number))
	elif f_condition == "power":
		e.insert(0, f_num ** int(second_number))
...
#button_point = Button(root, text = ".", padx = 40, pady = 20, command = button_click)
